package com.woniuxyBook.protal;
                ...
                .globalConfig(builder -> {
                    builder.author("woniuxy") // 设置作者
                            ...
                            .dateType(DateType.ONLY_DATE).disableOpenDir().outputDir(
                                    "D:\\snailCode\\woniuBook-parent\\spring-woniubook-protal\\src\\main\\java"); // 指定输出目录
                }).packageConfig(builder -> {
                    builder.parent("com.woniuxy.protal") // 设置父包名
                            .moduleName(null) // 设置父包模块名
                            .pathInfo(Collections.singletonMap(
                                    OutputFile.xml, "D:\\snailCode\\woniuBook-parent\\spring-woniubook-protal\\src\\main\\resources\\mapper")); // 设置mapperXml生成路径
